...
const AUDIO_EFFECTS_LIST = [
  ...
  { key: 'flanger', title: '🌊 Flanger To'lqin Effekti' },
  ...
  { key: 'alienPitch', title: 'O'zga Sayyoralik Ovoz' },
  ...
  { key: 'wideSpreader', title: '🎛 O'ta Keng Stereo Maydon' },
  { key: 'tunnelReverb', title: '🚇 Tonnell Ichidagi Ovoz' },
  { key: 'tapeStop', title: '⏸ Kassetani To'xtatish Effekti' },
